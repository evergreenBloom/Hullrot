    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out _, out var comp))
        {
            ...
            var stateActions = new Dictionary<int, Action>
            {
                ...
                { 2, () => _damageable.TryChangeDamage(uid, comp.Damage * frameTime, ignoreResistances: true)},
                { 3, () => _stun.TryKnockdown(uid, comp.StatusEffectTime, true)},
                { 4, () => Disable(uid, comp)},
                { 5, () => _mobState.ChangeMobState(uid, MobState.Dead)},
            };
