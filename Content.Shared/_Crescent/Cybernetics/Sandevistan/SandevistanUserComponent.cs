...
public sealed partial class SandevistanUserComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier? StartSound = new SoundPathSpecifier("/Audio/_Crescent/Misc/sande_start.ogg");

    [DataField]
    public SoundSpecifier? EndSound = new SoundPathSpecifier("/Audio/_Crescent/Misc/sande_end.ogg");
